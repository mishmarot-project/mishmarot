...
**We are not a response coordination platform.** SCN's Project RAIN and the Jewish Security Operations Command Center (JSOCC) handle real-time threat response for the Jewish community. We provide situational awareness — the picture of what is happening — not incident management or response coordination. Duplicating that capability would be redundant and potentially dangerous.
